...
/*compare against a know standard, the DS18B20 next to it in the room should be fine, if BME say 24.5 and DS18 say 23.5, then an offset of 1 is needed*/

#define sample_rate_mode (BSEC_SAMPLE_RATE_LP)

int g_i2cFid; // I2C Linux device handle
/*SECONDARY = 077, PRIMARY = 076*/
